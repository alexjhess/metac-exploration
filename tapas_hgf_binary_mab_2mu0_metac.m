function [traj, infStates] = tapas_hgf_binary_mab_2mu0_metac(r, p, varargin)
...
if ~isempty(varargin) && strcmp(varargin{1},'trans')
    p = tapas_hgf_binary_mab_2mu0_metac_transp(r, p);
end
...
for bidx = 1:b
    if bidx == 1
        mu(1,1,bidx) = tapas_sgm(mu_0(2), 1);
        mu(1,2,bidx) = mu_0(2);
    elseif bidx == 2
        mu(1,1,bidx) = tapas_sgm(mu2_0, 1);
        mu(1,2,bidx) = mu2_0;
    end
end
pi(1,1,:) = Inf;
mu(1,3:end,:) = repmat(mu_0(3:end),[1 1 b]);
